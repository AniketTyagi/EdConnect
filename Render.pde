...
void randomEnglish() {
  for(int i = 0; i < 15; i++) {
    double[] attributes = {random(20)+60, random(20)+80, random(20)};
    double[] grades = {random(20)+40, 1};
...
void randomHistory() {
  for(int i = 0; i < 15; i++) {
    ...
    double[] grades = {random(20)+40, 1};
    History.addGrade("Le", "Havi", grades, attributes, month(), day(), year());
    History.studentGradeAverage("Le", "Havi");
  }
}
